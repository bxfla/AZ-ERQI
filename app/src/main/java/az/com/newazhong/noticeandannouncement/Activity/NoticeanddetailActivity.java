...
public class NoticeanddetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showNotice = (ShowNotice) intent.getSerializableExtra("bean");
        tvTitle.setText(showNotice.getTitle());
        tvDepartment.setText(showNotice.getName());
        tvTime.setText(showNotice.getTime());
        ...
        webView.loadDataWithBaseURL(null,showNotice.getContent(),"text/html","utf-8",null);
