...
public class CommunityDetailActivity extends BaseActivity {
    ...
    ShowActivityPhoto showActivityPhoto;
    @Bind(R.id.webView)
    WebView webView;
    int width;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showActivityPhoto = (ShowActivityPhoto) intent.getSerializableExtra("bean");
        tvTitle.setText(showActivityPhoto.getTitle());
        tvDepartment.setText(showActivityPhoto.getName());
        tvTime.setText(showActivityPhoto.getTime());
        ...
        webView.loadDataWithBaseURL(null,showActivityPhoto.getContent(),"text/html","utf-8",null);
    ...
    protected int provideContentViewId() {
        return R.layout.activity_noticeand_detail;
    }
