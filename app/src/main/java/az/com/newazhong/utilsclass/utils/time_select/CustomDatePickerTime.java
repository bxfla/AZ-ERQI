package az.com.newazhong.utilsclass.utils.time_select;
 ...
 */
public class CustomDatePickerTime {
    ...
    public CustomDatePickerTime(Context context, ResultHandler resultHandler, String startDate, String endDate, TextView etData) {
        if (isValidDate(startDate, "yyyy-MM-dd HH:mm") && isValidDate(endDate, "yyyy-MM-dd HH:mm")) {
            canAccess = true;
            this.context = context;
            this.textView =  etData;
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                textView.setText(sdf.format(selectedCalender.getTime()));
                datePickerDialog.dismiss();
            }
        });
    }
