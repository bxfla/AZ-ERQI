...
public class CustomTimePicker {
    ...
    private TimePickerView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    private void initView() {
        year_pv = (TimePickerView) datePickerDialog.findViewById(R.id.year_pv);
        month_pv = (TimePickerView) datePickerDialog.findViewById(R.id.month_pv);
        day_pv = (TimePickerView) datePickerDialog.findViewById(R.id.day_pv);
        hour_pv = (TimePickerView) datePickerDialog.findViewById(R.id.hour_pv);
        minute_pv = (TimePickerView) datePickerDialog.findViewById(R.id.minute_pv);
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new TimePickerView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new TimePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new TimePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new TimePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new TimePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
