...
public class RichTextView extends TextView {
      ...
      public void onGlobalLayout() {
        ...
        stringBuilder = (SpannableStringBuilder) Html.fromHtml(source,
            new GlideImageGetter(mContext, Glide.with(mContext), RichTextView.this, false,
                    (((View) getParent()).getWidth()-100),  height), null);
  ...
  public void setHtml1(final String source, final int height) {
    getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
      @Override
      public void onGlobalLayout() {
        getViewTreeObserver().removeGlobalOnLayoutListener(this);
        //Html.form()生成Spanned
        stringBuilder = (SpannableStringBuilder) Html.fromHtml(source,
                new GlideImageGetterNoImg(mContext, Glide.with(mContext), RichTextView.this, false,
                        ((View) getParent()).getWidth(), 0), null);
