 ...
 * Html图文混排
 */
final class GlideImageGetterNoImg implements Html.ImageGetter, Drawable.Callback {
	...
	public GlideImageGetterNoImg(Context context, RequestManager glide, TextView targetView, boolean animated, int width, int height) {
	...
	public static void clear(TextView view) {
		...
		if (tag instanceof GlideImageGetterNoImg) {
			((GlideImageGetterNoImg)tag).clear();
			view.setTag(null);
		}
	}
	@Override
