...
public class CustomDatePickerDay {
    ...
    public CustomDatePickerDay(Context context, ResultHandler resultHandler, String startDate, String endDate, TextView etData) {
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                textView.setText(sdf.format(selectedCalender.getTime()).split(" ")[0]);
                datePickerDialog.dismiss();
            }
        });
    }
