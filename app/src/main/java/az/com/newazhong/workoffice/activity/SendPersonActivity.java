...
import az.com.newazhong.workoffice.adapter.SendPersonAdapter;
...
public class SendPersonActivity extends BaseActivity implements SendPersonAdapter.CallBackPosition,
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Constant.TAG_ONE:
                    ...
                    SendPersonDepAdapter adapter1 = new SendPersonDepAdapter(SendPersonActivity.this, listDep);
                    LinearLayoutManager manager1 = new LinearLayoutManager(SendPersonActivity.this);
                    recyclerViewDep.setLayoutManager(manager1);
                    recyclerViewDep.setAdapter(adapter1);
                    adapter1.setOnDepItemLitener(SendPersonActivity.this);
//                    ProgressDialogUtil.stopLoad();
                    break;
                case Constant.TAG_TWO:
                    Toast.makeText(SendPersonActivity.this, "请求数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case Constant.TAG_THREE:
                    ProgressDialogUtil.stopLoad();
                    new SharedPreferencesHelper(SendPersonActivity.this, "login").removeData(SendPersonActivity.this);
                    Intent intent = new Intent(SendPersonActivity.this, LoginActivity.class);
...
//        listPerson.clear();
    ...
    public void onDepItemClick(int position) {
        ...
        if (listPerson2.size() == 0) {
            ...
            SendPersonAdapter adapter = new SendPersonAdapter(SendPersonActivity.this, listPerson2);
            LinearLayoutManager manager = new LinearLayoutManager(SendPersonActivity.this);
            recyclerView.setLayoutManager(manager);
            recyclerView.setAdapter(adapter);
            adapter.setOnItemLitener(SendPersonActivity.this);
